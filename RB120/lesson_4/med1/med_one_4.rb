...
Create a class called Greeting with a single instance method called greet that takes
...
of the Greeting class greet method when implementing the Hello and Goodbye classes -
