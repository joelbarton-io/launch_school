class EmployeeManagementSystem
  ...
  def exists?(employee)
    employees.any? { |e| e == employee } # checks to potentially added employee is already in
  end
...
class Employee
  ...
  def ==(other)
    serial_number == other.serial_number # compares serial numbers of employees in the array
  end
...
miller_contracting = EmployeeManagementSystem.new('Miller Contracting') #instantiation

becca = Employee.new('Becca', '232-4437-1932')
raul = Employee.new('Raul', '399-1007-4242')
natasha = Employee.new('Natasha', '399-1007-4242') # instantiation of some Employee objs
